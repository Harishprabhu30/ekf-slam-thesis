...
class TrajectoryPhaseMarker(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("4 = SPIN CCW")
        self.get_logger().info("5 = ARC LEFT")
        self.get_logger().info("6 = ARC RIGHT")
        self.get_logger().info("7 = CLUTTER NAV")

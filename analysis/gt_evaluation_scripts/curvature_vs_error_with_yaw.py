...
if __name__ == "__main__":
    ...
    ap.add_argument("--out_csv", default="analysis/results_gt_traj_v3/curvature_error_yaw_analysis.csv")
    ap.add_argument("--out_scatter", default="analysis/results_gt_traj_v3/curvature_vs_ate_scatter.png")
    ap.add_argument("--out_time", default="analysis/results_gt_traj_v3/curvature_vs_time.png")
    ap.add_argument("--out_bins", default="analysis/results_gt_traj_v3/curvature_error_bins.png")
    ap.add_argument("--out_yaw", default="analysis/results_gt_traj_v3/yaw_error_vs_curvature.png")
    args = ap.parse_args()
    ...
    # curvature and incremental distance
    ...
    df_bins = pd.concat([df_bins_wheel, df_bins_ekf], ignore_index=True)
